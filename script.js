...
var countDownDate = new Date("Apr 29, 2025 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        ...
        // document.getElementById("time").href = "https://vishalaarti2025.github.io/RingCeremony/";
...
console.log('\n\n%c SAVE THE DATE: 29th Apr, 2025', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Himanshu', styles1, styles2);
